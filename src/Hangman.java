...
public class Hangman {
    ...
    public static String[] readString(String HangmanWordList) throws FileNotFoundException {
        ...
        File file = new File("D:\\"+HangmanWordList);
    ...
    public static String oneguess() throws FileNotFoundException {
        String oneguess="";
        while (true) {
            System.out.println("Guess a character that's in the word; or guess the word; or type in * for a hint: ");
            Scanner scanner = new Scanner(System.in);
    ...
    public static void giveahint() {
        ...
        if (hintused == true) {
            System.out.println("You've already used the one hint. Now do your own work. ");
            return;
        }
        ...
        if (lives < 7) {
            ...
            System.out.println("You haven't made any wrong guesses yet. No hint for you. Keep going!");
        }
    }
    public static void main(String[] args) throws FileNotFoundException{
        ...
        while (true) {
                ...
                if (inputlen > 1) {
                    ...
                    for (String tmp : incorrectchars ) {
                        if (tmp.equals(oneguess)) {
                            System.out.println("You've already guessed this and I have already told you it's wrong. Now be serious please:");
                            alreadyguessed = true;
                            //break;
                        }
            ...
            if (lives>0) {
                printHangMan(lives);
                System.out.println ("Congratulations, you guessed it right. The word is indeed: ");
                System.out.println (word);
            }
            else {
                printHangMan(lives);
